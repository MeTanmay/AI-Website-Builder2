...
export const Signin = ({ isDarkMode, setIsDarkMode }: { isDarkMode: boolean; setIsDarkMode: (value: boolean) => void }) => {
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link to="/signup" className="block text-gray-600 dark:text-gray-300 hover:text-blue-600 px-3 py-2">Sign Up</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      <div className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-xl w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Login to Your Account</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Terms</a>
</li>
